...
import com.aim.extras.TimeAndDateConverter;
...
public class SearchForecastRVAdapter extends RecyclerView.Adapter<SearchForecastRVAdapter.ForecastViewHolder>{
    ...
    List<com.aim.model.ForecastWeather.List> weatherList;
    private Context context;
    private String tempUnit;

    public SearchForecastRVAdapter(List<com.aim.model.ForecastWeather.List> weatherList, Context context, String tempUnit) {
    ...
    public void updateCollection(List<com.aim.model.ForecastWeather.List> weatherList){
        this.weatherList = weatherList;
